    ...
    <nav class="order">
        <div class="container mt-4 mb-5">
                ...
                <div class="col-md-7">
                    <div class="row detail-order">
                        ...
                        <div class="col-md form-step">
                            ...
                            <span class="ps-2">2<span class="text-secondary">/2</span></span>
                        </div>
                    </div>
                    <input type="hidden" name="holiday_in_number" value="{{ $holidayInNumber }}">
                    <input type="hidden" name="holiday_in_day" value="{{ $holidayInDay }}">
                    <input type="hidden" name="selang_waktu_penjemputan" value="{{ $selangWaktuPenjemputan->value }}">
                    <div class="row mt-4">
                        <div class="col fw-semibold">
                            <form action="/order/details" method="post" id="detailOrderForm">
                                @csrf
                                    ...
                                    <div class="identity mb-4">
                                        ...
                                        @if ($transactions['transaction_type'] == 'dropzone')
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="2" placeholder="Alamat" autocomplete="off">{{ old('address', ($identity['address']) ?? '' ) }}</textarea>
                                                @error('address')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        @else
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="2" placeholder="Alamat" required>{{ old('address', ($identity['address']) ?? '' ) }}</textarea>
                                                @error('address')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <div class="row mt-5 submit-desktop">
                                    <div class="col">
                                        <a href="/order" class="btn btn-outline-my-primary py-2 w-100 btn-back">Sebelumnya</a>
                                    </div>
                                    <div class="col">
            ...
            <div class="order-summary-mobile fixed-bottom">
                ...
                <div class="row">
                    <div class="col">
                        <a href="/order" class="btn btn-outline-my-primary py-2 w-100 btn-back-mobile">Sebelumnya</a>
                    </div>
                    <div class="col">
...
@section('scripts')
    <script src="{{ asset('assets/js/page/details-dropzone.js') }}"></script>
@endsection