    ...
    <div class="container mt-4">
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/dashboard/master-data/gallery" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="name" class="form-label">Name</label>
                            <input class="form-control @error('name') is-invalid @enderror" type="text" id="name" name="name" placeholder="Gallery's name" autocomplete="off" value="{{ old('name') }}">
                            @error('name')
